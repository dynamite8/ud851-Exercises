...
//        setContentView(R.layout.activity_main);
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(getResources().getString(R.string.timeFormat));
        ...
        String formattedUntilBoardingTime = String.format(getResources().getString(R.string.countDownFormat), hoursUntilBoarding, minutesUntilBoarding);
        mBinding.textViewBoardingInCountdown.setText(formattedUntilBoardingTime);
    }
}
