...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.itemView.setBackground(new ColorDrawable(backgroundColor));

        // COMPLETED (15) Increment viewHolderCount and log its value
        viewHolderCount++;
        Log.i(this.getClass().getSimpleName(), "Incremented viewHolderCounter to " + viewHolderCount);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        public NumberViewHolder(View itemView) {
            ...
            viewHolderIndexTextView = itemView.findViewById(R.id.tv_view_holder_instance);
        }
