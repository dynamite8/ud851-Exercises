...
public class TaskContentProvider extends ContentProvider {
    ...
    public static final int DIRECTORY_ID = 100;
    public static final int SINGLE_ITEM_ID = 101;
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, DIRECTORY_ID);
        matcher.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", SINGLE_ITEM_ID);
        return matcher;
    }
